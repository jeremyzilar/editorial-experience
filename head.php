      ...
      <div class="col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
        <div class="row">
          ...
          <div class="col-sm-8 col-md-9">
            ...
            <p><a class="btn btn-sm btn-learn" href="<?php echo esc_url( home_url( '/' ) ); ?>#blog" role="button">Learn More</a> <a class="btn btn-sm btn-buy" href="http://www.amazon.com/dp/1592538959/?tag=themapstrsch-20" role="button">Buy the Book</a></p>
          </div>
        </div>
      </div>
    </div>
